...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/stackdatastructure.o
...
${OBJECTDIR}/stackdatastructure.o: stackdatastructure.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stackdatastructure.o stackdatastructure.cpp
